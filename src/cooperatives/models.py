...
class Member(models.Model):
    ...
    # Farmer code (e.g. "TCC BMB 009") is globally unique — used as a portable farmer
    # identity for traceability, independent of member_id which is scoped to a cooperative.
...
class ProductionRecord(models.Model):
    ...
    # farm is optional: cherry deliveries are recorded station→member directly, without
    # requiring a registered Farm record first. Generic records still require it (see clean()).
